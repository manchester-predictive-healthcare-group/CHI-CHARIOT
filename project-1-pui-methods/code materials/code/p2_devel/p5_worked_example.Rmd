...
### Function to apply odds ratio to a risk score, based on change in SBP, BMI and Non-HDL (old; no longer used)
...
convert_risk_HR <- function(p, change_sbp = 0, change_bmi = 0, change_nonhdl = 0){
...
pred_model4_visit0_sbp130 <- convert_risk_HR(p = pred_model4_visit0_sbp140, change_sbp = -10)
pred_model4_visit0_sbp120 <- convert_risk_HR(p = pred_model4_visit0_sbp140, change_sbp = -20)
...
###
pred_model4_visit0_bmi25 <- convert_risk_HR(p = pred_model4_visit0_sbp140, change_sbp = -wl_sbp_reduction, change_bmi = -wl_bmi_reduction, change_nonhdl = -wl_nonhdl_reduction)
...
### Statins
###
pred_model4_visit0_statins <- convert_risk_HR(p = pred_model4_visit0_sbp140, 
...
###
pred_model4_visit0_healthy <- convert_risk_HR(p = pred_model4_visit0_sbp140, 
                                         change_sbp = -20, 
                                         change_bmi = -5, 
                                         change_nonhdl = -2.4)
...
pred_model4_visit1_factual <- convert_risk_HR(p = pred_model4_visit1_sbp140, 
                                                change_sbp = 0, 
                                                change_bmi = -5, 
                                                change_nonhdl = -1)
...
pred_model4_visit1_hypo_sbp130 <- convert_risk_HR(p = pred_model4_visit1_sbp140, 
                                                    change_sbp = -10, 
                                                    change_bmi = -5, 
                                                    change_nonhdl = -1)

pred_model4_visit1_hypo_sbp120 <- convert_risk_HR(p = pred_model4_visit1_sbp140, 
                                                    change_sbp = -20, 
                                                    change_bmi = -5, 
                                                    change_nonhdl = -1)
...
pred_model4_visit0_arbitrary <- convert_risk_HR(p = pred_model4_visit0_sbp140, 
