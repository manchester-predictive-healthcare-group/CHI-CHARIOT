...
for (gender in c(2,1)){
  ...
  fit_model <- function(imp.num){
    ...
    ### Save fit
    saveRDS(fit, paste("data/p4/prototype3_4knots_caltime_cox_", gender, "_imp", imp.num, ".rds", sep = ""))
    saveRDS(bhaz, paste("data/p4/prototype3_4knots_caltime_cox_bhaz_", gender, "_imp", imp.num, ".rds", sep = ""))
    saveRDS(bhaz.uncent, paste("data/p4/prototype3_4knots_caltime_cox_bhaz_uncent_", gender, "_imp", imp.num, ".rds", sep = ""))
