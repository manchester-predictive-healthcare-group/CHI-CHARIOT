...
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, var.binary, ".png", sep = ""))
```
...
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, "2_", var.poly, ".png", sep = ""))
```

*Male Hazard Ratios*

```{r,  echo = FALSE, out.width = "33%", fig.show = "hold", fig.align = "default"}
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, "1_", var.poly, ".png", sep = ""))
```
...
```{r,  echo = FALSE, out.width = "33%", fig.show = "hold", fig.align = "default"}
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, "2_", var.cont, ".png", sep = ""))
```

*Male Hazard Ratios*

```{r,  echo = FALSE, out.width = "33%", fig.show = "hold", fig.align = "default"}
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, "1_", var.cont, ".png", sep = ""))
```
...
knitr::include_graphics(paste("../../../figures/p4/prototype3_4knots_assess_nonlinear", savename, "age.png", sep = ""))
```