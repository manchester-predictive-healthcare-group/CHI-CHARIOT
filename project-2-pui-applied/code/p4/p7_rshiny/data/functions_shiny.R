...
create_table <- function(pat,
  ...
  pat.risks[3] <- round(rr.change.total, dp)
  pat.risks[4] <- round(rr.change.sbp, dp)
  pat.risks[5] <- round(rr.change.bmi, dp)
  pat.risks[6] <- round(rr.change.nonhdl, dp)
  pat.risks[7] <- round(rr.change.smoking, dp)
