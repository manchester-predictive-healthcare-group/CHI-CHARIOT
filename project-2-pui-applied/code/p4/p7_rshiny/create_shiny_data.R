...
### Read in prototye3
fit.prototype3.female <- lapply(1:10, function(x) {readRDS(paste("data/p4/prototype3_4knots_caltime_cox_", 2, "_imp", x, ".rds", sep = ""))})
bhaz.prototype3.female <- lapply(1:10, function(x) {readRDS(paste("data/p4/prototype3_4knots_caltime_cox_bhaz_", 2, "_imp", x, ".rds", sep = ""))})

### Standard model
fit.standard.female <- lapply(1:10, function(x) {readRDS(paste("data/standard_cox_", 2, "_imp", x, ".rds", sep = ""))})
bhaz.standard.female <- lapply(1:10, function(x) {readRDS(paste("data/standard_cox_bhaz_", 2, "_imp", x, ".rds", sep = ""))})

### Read in prototype3
fit.prototype3.male <- lapply(1:10, function(x) {readRDS(paste("data/p4/prototype3_4knots_caltime_cox_", 1, "_imp", x, ".rds", sep = ""))})
bhaz.prototype3.male <- lapply(1:10, function(x) {readRDS(paste("data/p4/prototype3_4knots_caltime_cox_bhaz_", 1, "_imp", x, ".rds", sep = ""))})

### Standard model
fit.standard.male <- lapply(1:10, function(x) {readRDS(paste("data/standard_cox_", 1, "_imp", x, ".rds", sep = ""))})
bhaz.standard.male <- lapply(1:10, function(x) {readRDS(paste("data/standard_cox_bhaz_", 1, "_imp", x, ".rds", sep = ""))})
...
### Get the maximum follow-up, which is what we will set caltime to
max_caltime <- max(data.valid$caltime)
### Check its 15 and a quarter years
max_caltime/365.25
