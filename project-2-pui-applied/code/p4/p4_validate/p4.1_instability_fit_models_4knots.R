...
### Save fit
saveRDS(fit, paste("data/p4/prototype3_4knots_stability_cox_", gender, "_samp", seed, ".rds", sep = ""))
saveRDS(bhaz, paste("data/p4/prototype3_4knots_stability_cox_bhaz_", gender, "_samp", seed, ".rds", sep = ""))
saveRDS(offset_means, paste("data/p4/prototype3_4knots_stability_offset_means_", gender, "_samp", seed, ".rds", sep = ""))
