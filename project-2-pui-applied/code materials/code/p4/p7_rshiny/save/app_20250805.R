...
server <- function(input, output, session) {
  ...
  observeEvent(input$predictrisks, {
    ...
    direct_RR_smoking_initiation <- readRDS("data/direct_RR_smoking_initiation.rds")
    direct_RR_smoking_cessation <- readRDS("data/direct_RR_smoking_cessationn.rds")
    direct_RR_sbp <- readRDS("data/direct_RR_sbpn.rds")
    direct_RR_bmi <- readRDS("data/direct_RR_bmin.rds")
    direct_RR_nonhdl <- readRDS("data/direct_RR_nonhdln.rds")
