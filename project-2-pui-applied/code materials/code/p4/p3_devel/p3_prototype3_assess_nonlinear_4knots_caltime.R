...
###
### Get fits
fit.female <- readRDS(paste("data/p4/prototype3_4knots_caltime_cox_", 2, "_imp1.rds", sep = ""))
fit.male <- readRDS(paste("data/p4/prototype3_4knots_caltime_cox_", 1, "_imp1.rds", sep = ""))
...
create_plot_binary_1model <- function(var, fit, dummydf, savename = "_"){
  ...
  ### Plot
  png(paste("figures/p4/prototype3_4knots_caltime_assess_nonlinear", savename, var, ".png", sep = ""), width = 6, height = 6, unit = "in", res = 300)
...
create_plot_age <- function(fit1 = fit.male, fit2 = fit.female, 
  ...
  ### Plot
  png(paste("figures/p4/prototype3_4knots_caltime_assess_nonlinear", savename, "age.png", sep = ""), width = 6, height = 6, unit = "in", res = 300)
  print(plot(hr.gg))
  dev.off()
...
refs <- c("bmi" = 25, "sbp" = 120, "nonhdl" = 3, "IMD" = 1, "caltime" = 0)
