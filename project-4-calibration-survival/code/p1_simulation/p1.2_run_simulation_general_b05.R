...
b.x2 <- c(0,0.5,0.5)[as.numeric(crossing[row, "DGM.y"])]
b.x3 <- c(0,0.5,0.5)[as.numeric(crossing[row, "DGM.y"])]
...
b.cens.x1 <- c(0,0.5,0.5,0.5)[as.numeric(crossing[row, "DGM.cens"])]
b.cens.x2 <- c(0,0,0.5,0.5)[as.numeric(crossing[row, "DGM.cens"])]
b.cens.x3 <- c(0,0,0.5,0.5)[as.numeric(crossing[row, "DGM.cens"])]
...
saveRDS(sim.out, paste("data/simulation_m", nrow(dat.valid), 
                       ...
                       "_teval", as.numeric(crossing[row, "t.eval"]), ".rds", sep = ""))
...
Cairo::CairoPNG(paste("figures/simulation_m", nrow(dat.valid),
                      ...
                      "_split", as.numeric(crossing[row, "splitdat"]), 
                      "_tcens", as.numeric(crossing[row, "t.cens"]),
                      "_teval", as.numeric(crossing[row, "t.eval"]), ".png", sep = ""), 
