...
# 4. Derivation of the total effects of statins, antihypertensives, and smoking, as hazards ratios,
...
# Convert HR → RR → OR
RR_BMI_direct <- convert_HR_to_RR_HRgt1(HR_BMI_direct, w, u)
RR_BMI_direct # 1.0197
OR_BMI_direct <- convert_RR_to_OR_gt1(RR_BMI_direct, w, u)[1]
OR_BMI_direct # 1.023184
...
#############################################################################################################
### 3. Derivation of direct HR for the modifiable risk factors, used for the modifiable risk factor model ###
#############################################################################################################
...
#
# ###
# ### Direct effects of each modifiable risk factor on CVD as hazard ratios (used in modifiable risk factor model in methods paper)
# ###
# saveRDS(log(HR_init_smok_direct), "data/p4/offsets_direct_lnHR_smoking_dummy1.rds")
# saveRDS(log(HR_former_smok_direct), "data/p4/offsets_direct_lnHR_smoking_dummy2.rds")
# saveRDS(log(HR_NonHDL_direct), "data/p4/offsets_direct_lnHR_nonhdl.rds")
# saveRDS(log(HR_BMI_direct), "data/p4/offsets_direct_lnHR_bmi.rds")
# saveRDS(log(HR_SBP_direct), "data/p4/offsets_direct_lnHR_sbp.rds")
#
# ###
