...
knitr::opts_knit$set(root.dir = "/mnt/bmh01-rds/Sperrin_CHARIOT_CPRD/Aurum_Jun2021_extract/")
```
...
###
incidence_year_female <- readRDS("data/extraction/cohort_baseline/incidence_by_year_female.rds")
incidence_year_male <- readRDS("data/extraction/cohort_baseline/incidence_by_year_male.rds")

incidence_age <- readRDS("data/extraction/cohort_baseline/incidence_by_age.rds")
incidence_age_female <- readRDS("data/extraction/cohort_baseline/incidence_by_age_female.rds")
incidence_age_male <- readRDS("data/extraction/cohort_baseline/incidence_by_age_male.rds")
```
